...
export const Store = types.model('Store', {
  ...
  return ({
    ...
    setCurrentScenario(scenario) {
      ...
      let visitedScenarios = localStorage.getItem('visitedScenarios');
      if (!visitedScenarios) {
        visitedScenarios = '[]'
      }
      let vss = JSON.parse(visitedScenarios);
      vss.push(self.repo + scenario.dir);
      localStorage.setItem('visitedScenarios', JSON.stringify(vss));
    },
    setLoading(flag) {
      self.loading = flag;
    },
